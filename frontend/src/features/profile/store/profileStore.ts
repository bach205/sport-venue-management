...
const ALL_ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'team_chat_50',   icon: '🌟', title: 'Team Chat Hero',     description: 'Sent 50+ messages to teammates',                        category: 'social',  xp: 175, unlockedAt: null,                   requirement: 'Send 50 messages', progress: 24 },
];

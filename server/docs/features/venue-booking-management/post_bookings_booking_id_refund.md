...
6. Nếu thời gian từ `paid_at` đến hiện tại không quá 15 phút:
...
10. Nếu đã quá 15 phút, service tạo `refund` type `manual`, status `pending_manual`, và giữ booking ở trạng thái `confirmed`.
